<%@ Page Language="C#" AutoEventWireup="true" CodeFile="project_edit.aspx.cs" Inherits="projects_project_edit" %>
...
<body>
    ...
    <label for="show" class="title"><b>Edit Project </b></label>
...
<div class="group">
    ...
    <asp:DropDownList ID="DropDownList1" runat="server" style="background-color:#ccc;" DataSourceID="SqlDataSource1" DataTextField="name" DataValueField="project_id"></asp:DropDownList>
    ...
    <div class="group">
        <div class="col-1">
            <label for="managerid"><b>Manager Id</span></b></label>
        </div>
        <div class="col-2">
   ...
   <!-- project Name -->
    <div class="group">
        <div class="col-1">
            <label for="projectname"><b>Project Name</span></b></label>
        </div>
        <div class="col-2">
    ...
    <div class="group">
        ...
        <div class="col-2">
            <asp:Label ID="startLabel" runat="server" Text=""></asp:Label>
            
        </div>
    </div>
    <div class="group">
        <div class="col-1">
            <label for="start"><b>New Start Date<span  style="color:red">*</span></b></label>
        </div>
        <div class="col-2">
            <asp:TextBox ID="start" TextMode="Date"    placeholder="Project Start Date" runat="server"></asp:TextBox>
    ...
    <div class="group">
        <div class="col-1">
            <label for="expected"><b>New Expected Date<span  style="color:red">*</span></b></label>
        </div>
        <div class="col-2">
            <asp:TextBox ID="expected"  TextMode="Date"   placeholder="Project New Expected End Date" runat="server"></asp:TextBox>
    ...
    <div class="group">
        ...
        <div class="col-2">
            <asp:TextBox ID="budget"   TextMode="Number"  placeholder="Project Budget" runat="server"></asp:TextBox>
        </div>
    </div>
     <!-- project labor cost -->
    <div class="group">
        ...
        <div class="col-2">
            <asp:TextBox ID="labour"   TextMode="Number"  placeholder="Labour Cost" runat="server"></asp:TextBox>
        </div>
    </div>
    ...
    <div class="group">
        ...
        <div class="col-2">
            <asp:TextBox ID="material"  onblur="change()"    placeholder="Material Cost" runat="server"></asp:TextBox>
        </div>
    </div>
    <!-- project total cost -->
    <div class="group">
