<%@ Page Language="C#" AutoEventWireup="true" CodeFile="project_view.aspx.cs" Inherits="projects_project_view" %>
...
<body>
    ...
    <label for="show" class="title"><b>View Project Details </b><i class="flag left"></i><i class="flag right"></i></label>
...
<div class="group">
  ...
  <br />
        <asp:Button ID="Button1"  CssClass="submit1"  runat="server" Text="Search" OnClick="Button1_Click" /> 
