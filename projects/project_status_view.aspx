<%@ Page Language="C#" AutoEventWireup="true" CodeFile="project_status_view.aspx.cs" Inherits="projects_project_status_view" %>
...
<body>
    ...
    <i class="flag left"></i><label for="show" class="title"><b>View Project Status</b></label><i class="flag right"></i>
...
<div class="group">
   ...
   <!-- <div class="group">
        <div class="col-1">
            <label for="final"><b>Employees<span  style="color:red"> *</span></b></label>
