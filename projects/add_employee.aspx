<%@ Page Language="C#" AutoEventWireup="true" CodeFile="add_employee.aspx.cs" Inherits="projects_add_employee" %>
...
<div class="group">
    ...
    <div class="group">
        <div class="col-1">
            ...
            <asp:DropDownList ID="DropDownList3" runat="server" DataSourceID="SqlDataSource2" DataTextField="emp_name" DataValueField="emp_id"></asp:DropDownList>
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:TestConnectionString %>" SelectCommand="SELECT [emp_name], [emp_id] FROM [employee_table]"></asp:SqlDataSource>
        </div>
        <div>
