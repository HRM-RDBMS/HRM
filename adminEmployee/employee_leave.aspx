<%@ Page Language="C#" AutoEventWireup="true" CodeFile="employee_leave.aspx.cs" Inherits="adminEmployee_employee_leave" %>
...
<body style="background-image:url(../images/imghggh.jpg)">
	...
	<div class="main">
		...
		<div class="agile-heading">
			<h1><span class="image">Leave Request</h1>
		</div>
					...
					<form runat="server" >
						...
						<div class="group" id="b1" runat="server">
							<div class="col2">
                                ...
                                <asp:Button ID="Button4" runat="server" Text="Approved Leaves" OnClick="Button4_Click" />
						       
						</div></div>
						<div class="group">
							<div class="col2">
                                <asp:Button ID="Button5" runat="server" Text="Rejected Leaves" OnClick="Button5_Click" />
							</div>
						</div>
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" DataSourceID="SqlDataSource3" ForeColor="Black" Width="603px" DataKeyNames="emp_id">
                            <Columns>
                                <asp:BoundField DataField="emp_id" HeaderText="Employee ID" SortExpression="emp_id" InsertVisible="False" ReadOnly="True" />
                                <asp:BoundField DataField="emp_name" HeaderText="Employee Name" SortExpression="emp_name" />
                                <asp:BoundField DataField="dt_from" HeaderText="Leave From" SortExpression="dt_from" />
                                <asp:BoundField DataField="till" HeaderText="Till" SortExpression="till" />
                            ...
                            <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:TestConnectionString %>" SelectCommand="SELECT employee_table.emp_name, employee_table.emp_id, Leave.dt_from, Leave.till, Leave.reason FROM employee_table INNER JOIN Leave ON employee_table.emp_id = Leave.employe_id WHERE (Leave.approval = 'Approved')"></asp:SqlDataSource>
						...
						<div class="col-2">
                            <asp:DropDownList ID="DropDownList1" runat="server"  DataSourceID="SqlDataSource1" DataTextField="emp_name" DataValueField="employe_id"></asp:DropDownList>
						    
						    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TestConnectionString %>" SelectCommand="SELECT employee_table.emp_name, Leave.employe_id FROM employee_table INNER JOIN Leave ON employee_table.emp_id = Leave.employe_id WHERE (Leave.approval = 'Pending')"></asp:SqlDataSource>
						    
						</div>
						</div>
						<div class="group" id="bt" runat="server">
                            <asp:Button ID="Button3" runat="server" Text="Fetch Details" OnClick="Button3_Click" Width="602px" />
						</div>
						...
						<div class="col-1">
						<label for="candidateid" style="color:black"><b>From</b></label>
						</div>
						<div class="col-2">
						<asp:Label ID="fromdate" runat="server" style="background-color:#ccc;" Text=""></asp:Label>
						</div>
						</div>
						<div class="group" id="g7" runat="server" >
						<div class="col-1">
						<label for="candidateid" style="color:black"><b>Till</b></label>
						</div>
						<div class="col-2">
						<asp:Label ID="till" runat="server" style="background-color:#ccc;" Text=""></asp:Label>
						</div>
						</div>

						<div class="group" id="g6" runat="server">
							<div class="col-1">
                                <asp:Button ID="Button1" OnClientClick="return confirm('Are you sure to Accept the Leave Request');" runat="server" Text="Accept Resignation" OnClick="Button1_Click" Width="198px" />
							</div>
							<div class="col-2">
                                <asp:Button ID="Button2" OnClientClick="return confirm('Are you sure to Decline the Leave Request');" runat="server" Text="Decline Resignation" OnClick="Button2_Click" Width="222px" />
							</div>
						</div>
