<%@ Page Language="C#" AutoEventWireup="true" CodeFile="training_delete.aspx.cs" Inherits="Training_training_delete" %>
...
<head id="Head1" runat="server">
    ...
    <title>Delete training Details</title>
<style>
    html, body, h2 {
    margin: 0;
    padding: 0.5em;
...
<body>
<center><h1>Delete Training Details</h1></center>
...
<asp:TextBox ID="search" runat="server" placeholder="training id" style="background-color:#ccc;"></asp:TextBox></div>
    <div><input type="submit" class="submit1" value="Search" />        
    </div>
    <br />  
     <!-- training Id -->
    ...
    <div class="group">
        <div class="col-1">
            <label for="trainingid"><b>Training Id</b></label>
        </div>
        <div class="col-2">
            <asp:TextBox ID="trainingid" runat="server" style="background-color:#ccc;"></asp:TextBox>
  ...
  <!-- training name -->
    ...
    <div class="group">
        ...
        <div class="col-2">
            <asp:TextBox ID="trainingname" runat="server"  style="background-color:#ccc;"></asp:TextBox>
  ...
  <!-- training category code -->
    ...
    <div class="group">
        <div class="col-1">
            <label for="tcategorycode"><b>T_Category code</b></label>
        </div>
        <div class="col-2">
            <asp:TextBox ID="tccode" runat="server" style="background-color:#ccc;" 
                ></asp:TextBox>
  ...
  <!-- training category name -->
    ...
    <div class="group">
        <div class="col-1">
            <label for="categoryname"><b>T_Category name</b></label>
        </div>
        <div class="col-2">
  ...
  <!-- training start date -->
    ...
    <div class="group">
        <div class="col-1">
            <label for="sdate"><b>T_Start date</b></label>
        </div>
        <div class="col-2">
  ...
  <!-- training ending date -->
    ...
    <div class="group">
        <div class="col-1">
            <label for="edate"><b>T_End date</b></label>
        </div>
        <div class="col-2">
   ...
   <!-- training company -->
    ...
    <div class="group">
        <div class="col-1">
            <label for="company"><b>Trainingcompany</b></label>
        </div>
        <div class="col-2">
            <asp:TextBox ID="company" runat="server" style="background-color:#ccc;" 
                ></asp:TextBox>
  ...
  <!-- training place -->
    ...
    <div class="group">
        <div class="col-1">
            <label for="place"><b>Training place</b></label>
        </div>
        <div class="col-2">
            <asp:TextBox ID="place" runat="server" style="background-color:#ccc;" 
                ></asp:TextBox>
  ...
  <!-- training time-->
    ...
    <div class="group">
        <div class="col-1">
            <label for="time"><b>T_Category code</b></label>
        </div>
        <div class="col-2">
            <asp:TextBox ID="TextBox3" runat="server" textmode="Time" style="background-color:#ccc;" 
                 ></asp:TextBox>
   ...
   <!-- Submit button -->
        <div class ="submit">
            ...
            <div class="submit">
                <asp:Button ID="submit" runat="server" Text="Delete" CssClass="submit" />
