<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Candidate_Details_View.aspx.cs" Inherits="formpages_Candidate_Details_View" %>
...
<head id="Head1" runat="server">
    ...
    <link href="css/CandidateView.css" rel="stylesheet" />
    <style>
...
<body>
    <form id="form1" method="post" runat="server">
        ...
        <div id="main">  
            ...
            <table>
            <tr>
            <td class="auto-style3"><b>Candidate Id to View:</b></td><td class="auto-style3">
