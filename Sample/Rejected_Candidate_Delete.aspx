<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rejected_Candidate_Delete.aspx.cs" Inherits="formpages_Rejected_Candidate_Delete" %>
...
<body>
    <form id="form1" method="post" runat="server">
        ...
        <div id="main">  
            ...
            <div class="container">
                <div class="inner2">
             <h3>Delete Rejected Candidate Profile !!!</h3>
            <fieldset style="width:420px">
            <legend><b>Candidate Details</b></legend>
            <table>
            <tr>
            <td class="auto-style7"><b>Rejected Id to Delete:</b></td><td class="auto-style3">
