<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rejected_Candidate_Edit.aspx.cs" Inherits="formpages_Rejected_Candidate_Edit" %>
...
<body>
    <form id="form1" method="post" runat="server">
        ...
        <div id="main">  
            ...
            <div class="container">
                <div class="inner2">
             <h3>Edit Rejected Candidate Profile !!!</h3>
            <fieldset style="width:420px">
            <legend><b>Candidate Details</b></legend>
            <table>
            <tr>
            <td class="auto-style3"><b>Rejected Id to Edit:</b></td><td class="auto-style3">
