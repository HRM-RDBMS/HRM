<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Recruited_Candidate_View.aspx.cs" Inherits="formpages_Recruited_Candidate_View" %>
...
<body>
    <form id="form1" method="post" runat="server">
        ...
        <div id="main">  
            ...
            <div class="container">
                <div class="inner2">
             <h3>View Recruited Candidate Profile !!!</h3>
            <fieldset style="width:420px">
            <legend><b>Candidate Details</b></legend>
            <table>
            <tr>
            <td class="auto-style3"><b>Recruited Id to View:</b></td><td class="auto-style3">
