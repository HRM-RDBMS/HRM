<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rejected_Candidate_Add.aspx.cs" Inherits="formpages_Rejected_Candidate_Add" %>
...
<body>
    <form id="form1" method="post" runat="server">
        ...
        <div id="main">  
            ...
            <div class="container">
                <div class="inner2">
             <h3><b>Rejected Candidate Details Entry</b> !!!</h3>
            ...
            <table>  
             <tr>
                ...
                <tr>
                    <td class="auto-style2"><b>Rejected Date:</b> </td><td class="auto-style2"><asp:textBox id="TextBox4" runat="server" TextMode="Date" Width="260px"></asp:textBox> </td>      
                </tr>
                 <tr>
