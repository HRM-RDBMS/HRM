<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Recruited_Candidate_Add.aspx.cs" Inherits="formpages_Recruited_Candidate_Add" %>
...
<body>
    <form id="form1" method="post" runat="server">
        ...
        <div id="main">  
            ...
            <div class="container">
                <div class="inner2">
             <h3><b>Recruited Candidate Details Entry</b> !!!</h3>
            ...
            <tr>
                ...
                <tr>
                    <td class="auto-style2"><b>Recruitement Date:</b> </td><td class="auto-style2"><asp:textBox id="TextBox4" runat="server" TextMode="Date" Width="260px"></asp:textBox> </td>      
                </tr>
                 <tr>
