<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Project_Details_Delete.aspx.cs" Inherits="formpages_Project_Details_Delete" %>
...
<head id="Head1" runat="server">
    ...
    <link href="../css/ProjectDelete.css" rel="stylesheet" />
    <style>
...
<body>
    <form id="form1" method="post" runat="server">
        ...
        <div id="main">  
            ...
            <div class="container">
                <div class="inner2">
             <h3>Delete Project Details !!!</h3>
            <fieldset style="width:420px">
            <legend><b>Project Details</b></legend>
            <table>
            <tr>
            <td class="auto-style3"><b>Project Id to Delete:</b></td><td class="auto-style3">
          ...
          <td class="auto-style5">
                        <br />
                        <asp:Button ID="btn1" runat="server" Text="Delete" 
